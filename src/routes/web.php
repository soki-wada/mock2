...
// ミドルウェア予定
        ...
        Route::get('admin/attendances', [UserController::class, 'showAdminList']);
        Route::get('admin/attendances/{id}', [UserController::class, 'showAdminDetail']);
        Route::post('/admin/attendances/{id}', [UserController::class, 'updateWorkTime']);
        Route::get('/admin/users/{user}/attendances', [UserController::class, 'showAdminIndex']);
        Route::get('admin/requests', [UserController::class, 'showAdminRequests']);
        Route::get('/admin/requests/{id}', [UserController::class, 'showAdminRequestsApproval']);
        Route::post('/admin/requests/{id}', [UserController::class, 'requestApprove']);